...
ip = "srop.pwn.wanictf.org"  # input the ip address written in the question. It should be string.
portnumber = 9006  # port number written in the question. Should be integer
rm = connect(
    ip, portnumber
